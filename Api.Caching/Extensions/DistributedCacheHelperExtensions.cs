...
namespace Api.Caching.Extensions
{
    ...
    {
        public static T GetOrCreate<T>(this IDistributedCache cache, string key, Func<T> factory, TimeSpan? slidingExpiration = null,
        ...
        public static async Task<T> GetOrCreateAsync<T>(this IDistributedCache cache, string key, Func<Task<T>> factory, TimeSpan? slidingExpiration = null,
            TimeSpan? absoluteExpirationRelativeToNow = null, DateTimeOffset? absoluteExpiration = null)
        {
