...
namespace Extensions
{
    public static class ObjectExtensions
    {
            ...
            foreach (var p in source.GetProperties())
                ...
                else if (p.PropertyType.IsIEnumerable())
                {
                    if (p.PropertyType.IsArray)
                    {
                        ...
                        if (sourceArray != null)
                        {
                            var newArray = CopyArrayValues(Array.CreateInstance(p.PropertyType.GetElementType() 
                                                                                ?? throw new InvalidOperationException(), sourceArray.Length), sourceArray);
        ...
        public static bool HasDefaultValue<T>(this T @object)
        {
